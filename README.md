...
`checkboth`: input a single frame and res information (e.g. `dict(width=width, height=integer)`; supports fractional and raw src_ values), output a set of error maps that are labeled in the top left.  
